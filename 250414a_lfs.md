...
可以考虑的包管理工具（以及配套的构建系统）：

ArchLinux [pacman](https://wiki.archlinux.org/title/Pacman)

AlpineLinux [apk](https://wiki.alpinelinux.org/wiki/Alpine_Package_Keeper)

Debian [apt](https://www.debian.org/doc/manuals/debian-reference/ch02.en.html#_debian_package_management_system)

还有比较新兴的[nix](https://nix.dev/manual/nix/2.24/)
